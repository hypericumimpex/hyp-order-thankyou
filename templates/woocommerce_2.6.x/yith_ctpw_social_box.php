...
<div id="yith-ctpw-social-box" class="yith-ctpw-tabs" style="display: none">
    ...
    <h2><?php echo apply_filters('ctpw_sharebox_title',__('Share on...','yith-custom-thankyou-page-for-woocommerce')); ?></h2>
    <?php /* socials tabs */ ?>
            ...
            <div id="yith-ctwp-social-slider" class="ctpw_facebook">
                ...
                <div class="yith-ctwp-social-slider_container">
                    <div id="yith-ctpw-tab_sharing_product">
                        ...
                        <div id="ctpw_facebook_p_id_<?php echo $_product->id; ?>"
                             class="yith-ctpw-tab_sharing_product_info">
                            <?php

                            //getting the image url
                            if (has_post_thumbnail($_product->id)) {
                                $att_id[0] = get_post_thumbnail_id($_product->id);
                            ...
                            if (get_option('ctpw_url_shortening') != 'none' && get_option('ctpw_url_shortening') != null && function_exists('YITH_url_shortener')) {
                                ...
                                'yith-custom-thankyou-page-for-woocommerce') . '\'' . $_product->get_title() . '\'' ; ?>" type="text" value="<?php
                                echo __('I\'ve just purchased: ','yith-custom-thankyou-page-for-woocommerce') . '\'' . $_product->get_title() . '\''
                                ; ?>" />
                            <?php
                            if (yit_get_prop($_product,'short_description') != '') {
                                $description = substr(strip_tags(strip_shortcodes(yit_get_prop($_product, 'short_description'))),0,250);
                            } else {
                                $description = substr(strip_tags(strip_shortcodes(yit_get_prop($_product, 'description'))),0,250);
                            }
                            ...
                            <div class="ctpw_share_it"><a  href="javascript:void(0);" onclick="ctpw_socialize('ctpw_facebook_p_id_<?php echo $_product->id; ?>')"><?php _e('Share','yith-custom-thankyou-page-for-woocommerce'); ?></a></div>
                ...
                foreach( $order->get_items() as $item ) {
                    ...
                    <div class="yith-ctwp-social-slider_container">
                        <div id="yith-ctpw-tab_sharing_product">
                            ...
                            <div id="ctpw_twitter_p_id_<?php echo $_product->id; ?>" class="yith-ctpw-tab_sharing_product_info">
                                 <?php
                                ...
                                <p id="twit_c_counter" style="display: none;"><?php _e('characters left','yith-custom-thankyou-page-for-woocommerce');
                                    ?> <span></span></p>
                            </div>
                            <div class="ctpw_share_it"><a  href="javascript:void(0);" onclick="ctpw_socialize('ctpw_twitter_p_id_<?php echo $_product->id; ?>')"><?php _e('Tweet','yith-custom-thankyou-page-for-woocommerce'); ?></a></div>
                            <div style="clear:both"></div>
                        </div>
                        <div style="clear:both"></div>
                    </div>
                ...
                foreach( $order->get_items() as $item ) {
                    ...
                    <div class="yith-ctwp-social-slider_container">
                        <div id="yith-ctpw-tab_sharing_product">
                            ...
                            <div id="ctpw_google_p_id_<?php echo $_product->id; ?>" class="yith-ctpw-tab_sharing_product_info">
                                <?php
                    ...
                    foreach( $order->get_items() as $item ) {
                        ...
                        <div class="yith-ctwp-social-slider_container">
                            <div id="yith-ctpw-tab_sharing_product">
                                ...
                                <div id="ctpw_pinterest_p_id_<?php echo $_product->id; ?>" class="yith-ctpw-tab_sharing_product_info">
                                    <?php
                                ...
                                <div class="ctpw_share_it"><a  href="javascript:void(0);" onclick="ctpw_socialize('ctpw_pinterest_p_id_<?php echo
                                    $_product->id; ?>')"><?php _e('Pin it','yith-custom-thankyou-page-for-woocommerce'); ?></a></div>
                                <div style="clear:both"></div>
                            </div>
                            <div style="clear:both"></div>
                        </div>
